      ...
      <div className="flex w-full gap-[60%]">
        <div className="flex flex-col text-lg gap-3">
          ...
          <select
            ...
            className="flex gap-3 bg-lilac-300 w-[200%] hover:bg-lilac-500 text-white p-2 rounded-md shadow-md mb-4 focus:outline-none focus:ring-2 focus:ring-white focus:border-white focus:shadow-[0_0_5px_#8b5cf6]"
          >
